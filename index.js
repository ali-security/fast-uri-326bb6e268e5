  ...
  if (matches) {
    ...
    if (parsed.host) {
      ...
      if (ipv4result === false) {
        ...
        // A bracket anywhere in the host marks an IP-literal attempt, so an
        // unbalanced or misplaced one is malformed rather than a reg-name:
        // "[fe80::1" or "prefix]@127.0.0.1" would otherwise fall through to the
        // IDN/percent-decoding paths below and be repaired into a different host.
